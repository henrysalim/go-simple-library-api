...
This project demonstrates **Standard Go Project Layout** and modern **Best Practices** including Dependency Injection, the Repository Pattern, and Go 1.22+ routing.
...
* **Language**: Go (Golang)
* **Database**: MySQL
* **Standard Lib**: `net/http`, `database/sql`, `encoding/json`
